...
#Function for drawing text onto the screen. Function contains expression
#for word wrap.
  if len(text) > 49:
    textLine1 = text[:48]
    textLine2 = text[48:]
...
#Class for creating unique healthbar objects for the player and computer pokemon.
  ...
  #Function for determining the appropriate current length of the green portion of the health bar
...
#Function for random selection of pokemon for the computer.=
  choice = random.randint(0,1) #Pick either 2 remaining
  #Images assigned to randomly chosen Pokemon
...
#Function for applying the series of steps in the player attack sequence.
...
def Battle(pPokemon, pMoveList, cPokemon, cMoveList, playerImgList, computerImgList):
  ...
  time.sleep(2)
  DISPLAYSURF.blit(background, (0,0))
  drawText("Opponent sent out " + cPokemon[0] + "!", font, DISPLAYSURF, 10,400, BLACK)
  DISPLAYSURF.blit(playerImgList[1], (0,195))
  drawText(pPokemon[0], font, DISPLAYSURF, 200, 320, BLACK)
  playerBar.drawRects()
  time.sleep(2)
